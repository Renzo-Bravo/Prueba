      ...
      <section className="footer-end">
        <div className="footer-column brand-col">
          ...
          <p className="footer-description">
            Evento solidario para familias, empresas y organizaciones que buscan
            transformar la realidad rural.
          </p>
        </div>
        ...
        <div className="footer-column contact-col">
          ...
          <div className="contact-info-footer">
            ...
            <a
              href="mailto:fundacion@cruzadapatagonica.org"
          ...
          <div className="footer-social">
            ...
            <a
              href="https://www.linkedin.com/company/fundacion-cruzada-patagonica/"
              target="_blank"
              className="social-link"
            >
